...
const ptBR: UIStrings = {
  ...
  vault: {
    ...
    seqDesc: 'Uma bandeja de carga e quatro berços. Qualquer berço aceita qualquer coluna — o que importa para este rack é a ordem em que você carrega, não onde. Ele gira cada coluna em cadeia e confere a sequência na quarta: errada, ejeta as quatro de volta para a bandeja. A ordem está num esquema que só a nave lê — pergunte à sua IA.',
    ...
    spinGauge: 'SPIN-UP',
    trayLabel: 'BANDEJA',
    seqWaiting: (n) => `${n} de 4 carregadas. O rack espera a próxima coluna.`,
    seqTripped: 'O rack desacelera e ejeta todas as colunas. Ordem errada — comece de novo pela bandeja.',
